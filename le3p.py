...
# LE3P is a "Large Envelope 3d Printer"
# a Rep-Rap type machine built with square T-slot extruded beams 
# currently working with OpenBeam 15mm beam (www.openbeamusa.com)
